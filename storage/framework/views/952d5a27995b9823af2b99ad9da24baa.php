                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.user.update', $user->id)); ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="kode_kasir" name="kode_kasir" value="<?php echo e($user->kode_kasir); ?>" readonly required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="form-group row center">
                                ...
                                <div class="col-sm-3">
                                    <a href="<?php echo e(route('admin.user.index')); ?>" class="btn btn-primary px-3">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Berkah Ibu App\abc\BekahIbuApp\resources\views/admin/user/edit.blade.php ENDPATH**/ ?>