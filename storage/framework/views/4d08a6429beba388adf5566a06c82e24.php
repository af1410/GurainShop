                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('penjualan.store')); ?>" method="POST" id="formPenjualan">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="total_keuntungan" id="total_keuntungan" class="form-control" readonly>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Berkah Ibu App\abc\laravel-11-multi-auth-main\resources\views/penjualan/create.blade.php ENDPATH**/ ?>