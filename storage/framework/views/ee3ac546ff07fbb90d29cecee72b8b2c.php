                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.barang.update', $barang->id_barang)); ?>" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="hargajual" name="hargajual" value="<?php echo e($barang->hargajual); ?>" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="satuanbarang" name="satuanbarang" value="<?php echo e($barang->satuanbarang); ?>" required>
                            </div>
...
<script>
    ...
    function hitungKeuntungan() {
        ...
        var keuntungan = hargaJual - hargaBarang;

        document.getElementById('keuntungan').value = keuntungan;
    }
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Berkah Ibu App\abc\BekahIbuApp\resources\views/admin/barang/edit.blade.php ENDPATH**/ ?>