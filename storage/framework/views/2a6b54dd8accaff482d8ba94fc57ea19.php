...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper mt-5">
        ...
        <!-- Main Header -->
        <?php echo $__env->make('admin.layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <!-- Sesuaikan dengan lokasi header Anda -->
        ...
        <!-- Footer -->
        <?php echo $__env->make('admin.layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <!-- Sesuaikan dengan lokasi footer Anda -->
...
</html><?php /**PATH D:\gurainshop\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>