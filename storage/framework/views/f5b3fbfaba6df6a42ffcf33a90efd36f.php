                                    ...
                                    fetch(form.action, {
                                        ...
                                        .then(data => {
                                            ...
                                            if (data.id_pembelian) {
                                                const urlDetailPembelian = `<?php echo e(route('pembelian.detail', ':id_pembelian')); ?>`.replace(':id_pembelian', data.id_pembelian);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Berkah Ibu App\abc\laravel-11-multi-auth-main\resources\views/pembelian/create.blade.php ENDPATH**/ ?>