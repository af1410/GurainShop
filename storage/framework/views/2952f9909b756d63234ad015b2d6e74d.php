...
<?php $component->withAttributes([]); ?>
    <h2 class="font-semibold text-xl text-gray-800 leading-tight text-center">
        <?php echo e(__('Owner Register')); ?>

    </h2>
    <form method="POST" action="<?php echo e(route('owner.register')); ?>">
        <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH E:\Berkah Ibu App\laravel-11-multi-auth-main\laravel-11-multi-auth-main\resources\views/owner/auth/register.blade.php ENDPATH**/ ?>