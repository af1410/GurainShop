                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="border p-3 mb-4 d-flex flex-column h-100">
                                    <form action="<?php echo e(route('owner.laporanjual.harian')); ?>" method="POST" class="flex-grow-1 d-flex flex-column">
                                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-4">
                                <div class="border p-3 mb-4 d-flex flex-column h-100">
                                    <form action="<?php echo e(route('owner.laporanjual.mingguan')); ?>" method="POST" class="flex-grow-1 d-flex flex-column">
                                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-4">
                                <div class="border p-3 mb-4 d-flex flex-column h-100">
                                    <form action="<?php echo e(route('owner.laporanjual.bulanan')); ?>" method="POST" class="flex-grow-1 d-flex flex-column">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('owner.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Berkah Ibu App\abc\laravel-11-multi-auth-main\resources\views/owner/laporanjual/index.blade.php ENDPATH**/ ?>