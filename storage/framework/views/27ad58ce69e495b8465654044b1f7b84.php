                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="border p-4 mb-4 rounded shadow-sm d-flex flex-column h-100">
                                    <form action="<?php echo e(route('admin.laporanjual.harian')); ?>" method="POST" class="flex-grow-1 d-flex flex-column">
                                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-4">
                                <div class="border p-4 mb-4 rounded shadow-sm d-flex flex-column h-100">
                                    <form action="<?php echo e(route('admin.laporanjual.mingguan')); ?>" method="POST" class="flex-grow-1 d-flex flex-column">
                                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-4">
                                <div class="border p-4 mb-4 rounded shadow-sm d-flex flex-column h-100">
                                    <form action="<?php echo e(route('admin.laporanjual.bulanan')); ?>" method="POST" class="flex-grow-1 d-flex flex-column">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\gurainshop\resources\views/admin/laporanjual/index.blade.php ENDPATH**/ ?>