                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.barang.store')); ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="namabarang" class="form-control" id="namabarang" value="<?php echo e(old('namabarang')); ?>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="jumlahbarang" class="form-control" id="jumlahbarang" value="<?php echo e(old('jumlahbarang')); ?>" required>
                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Berkah Ibu App\abc\BekahIbuApp\resources\views/admin/barang/create.blade.php ENDPATH**/ ?>