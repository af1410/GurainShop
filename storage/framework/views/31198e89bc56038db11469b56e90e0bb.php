        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="text-center mt-3 pb-5">
                    <a href="<?php echo e(route('penjualan.index')); ?>" class="btn btn-primary mr-3"> <i class="fa fa-arrow-left pr-1"></i>Kembali</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Berkah Ibu App\abc\BekahIbuApp\resources\views/penjualan/detail.blade.php ENDPATH**/ ?>