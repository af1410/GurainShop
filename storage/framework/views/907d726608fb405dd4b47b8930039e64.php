            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(route('admin.penjualan.create')); ?>" class="btn btn-success mb-3"><i class="fas fa-plus"></i> Tambah Penjualan</a>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href=" <?php echo e(route('admin.penjualan.detail', $penjualan->id_penjualan)); ?> " class="btn btn-primary btn-sm"><i class="fas fa-info-circle pr-1"></i>Detail Penjualan</a></td>
                                    <!-- <ul>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Berkah Ibu App\abc\BekahIbuApp\resources\views/admin/penjualan/index.blade.php ENDPATH**/ ?>