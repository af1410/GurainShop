        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card" id="notaPembelian">
                    <div class="card-body">
                        ...
                        <div class="text-right">
                            ...
                            <p><b>Kembali: </b>Rp <?php echo e(number_format($pembelian->kembali, 0, ',', '.')); ?></p>
                        </div>
                ...
                <div class="text-center mt-3 pb-5">
                    <a href="<?php echo e(route('admin.pembelian.index')); ?>" class="btn btn-primary mr-3"> <i class="fa fa-arrow-left pr-1"></i>Kembali</a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Berkah Ibu App\abc\BekahIbuApp\resources\views/admin/pembelian/detail.blade.php ENDPATH**/ ?>