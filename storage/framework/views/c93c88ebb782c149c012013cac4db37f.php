                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href=" <?php echo e(route('pembelian.detail', $pembelian->id_pembelian)); ?> " class="btn btn-primary btn-sm"><i class="fas fa-info-circle pr-1"></i>Detail Pembelian</a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Berkah Ibu App\abc\BekahIbuApp\resources\views/pembelian/index.blade.php ENDPATH**/ ?>