            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('penjualan.store')); ?>" method="POST" id="formPenjualan">
                            <?php echo csrf_field(); ?>

                            <div class="form-group">
                                <label for="id_pelanggan">Admin</label>
                                <input class="form-control" type="text" name="id_user" id="id_user" value="<?php echo e(Auth::user()->id); ?>" hidden>
                                <input class="form-control" type="text" name="" value="<?php echo e(Auth::user()->name); ?>" readonly>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group row center">
                                ...
                                <div class="col-sm-3">
                                    <a href="<?php echo e(route('penjualan.index')); ?>" class="btn btn-primary px-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Berkah Ibu App\abc\BekahIbuApp\resources\views/penjualan/create.blade.php ENDPATH**/ ?>