...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <!-- Main Header -->
        @include('owner.layouts.header') <!-- Sesuaikan dengan lokasi header Anda -->

        <!-- Sidebar -->
        @include('owner.layouts.sidebar') <!-- Sesuaikan dengan lokasi sidebar Anda -->
        ...
        <!-- Footer -->
        @include('owner.layouts.footer') <!-- Sesuaikan dengan lokasi footer Anda -->
