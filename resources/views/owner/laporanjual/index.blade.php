                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="border p-3 mb-4 d-flex flex-column h-100">
                                    <form action="{{ route('owner.laporanjual.harian') }}" method="POST" class="flex-grow-1 d-flex flex-column">
                                        @csrf
                            ...
                            <div class="col-md-4">
                                <div class="border p-3 mb-4 d-flex flex-column h-100">
                                    <form action="{{ route('owner.laporanjual.mingguan') }}" method="POST" class="flex-grow-1 d-flex flex-column">
                                        @csrf
                            ...
                            <div class="col-md-4">
                                <div class="border p-3 mb-4 d-flex flex-column h-100">
                                    <form action="{{ route('owner.laporanjual.bulanan') }}" method="POST" class="flex-grow-1 d-flex flex-column">
                                        @csrf
