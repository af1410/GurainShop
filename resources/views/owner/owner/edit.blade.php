            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('owner.owner.update', $owner->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                                <label for="name" class="form-label">Kode Owner</label>
                                <input type="text" class="form-control" id="kode_owner" name="kode_owner" value="{{ $owner->kode_owner }}" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="form-group row center">
                                ...
                                <div class="col-sm-3">
                                    <a href="{{ route('owner.owner.index') }}" class="btn btn-primary px-3">
