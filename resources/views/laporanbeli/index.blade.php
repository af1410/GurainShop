                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="border p-3 mb-4 d-flex flex-column h-100">
                                    <form action="{{ route('laporanbeli.harian') }}" method="POST" class="flex-grow-1 d-flex flex-column">
                                        @csrf
                            ...
                            <div class="col-md-4">
                                <div class="border p-3 mb-4 d-flex flex-column h-100">
                                    <form action="{{ route('laporanbeli.mingguan') }}" method="POST" class="flex-grow-1 d-flex flex-column">
                                        @csrf
                            ...
                            <div class="col-md-4">
                                <div class="border p-3 mb-4 d-flex flex-column h-100">
                                    <form action="{{ route('laporanbeli.bulanan') }}" method="POST" class="flex-grow-1 d-flex flex-column">
                                        @csrf
