...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <!-- Main Header -->
        @include('layouts.header') <!-- Sesuaikan dengan lokasi header Anda -->

        <!-- Sidebar -->
        @include('layouts.sidebar') <!-- Sesuaikan dengan lokasi sidebar Anda -->
        ...
        <!-- Footer -->
        @include('layouts.footer') <!-- Sesuaikan dengan lokasi footer Anda -->
