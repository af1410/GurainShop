...
<nav class="main-header navbar navbar-expand navbar-light fixed-top">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block @if(request()->is('penjualan*')) active @endif">
            <a href="{{ route('penjualan.index') }}" class="nav-link">Penjualan</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block @if(request()->is('pelanggan*')) active @endif">
