                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('penjualan.store') }}" method="POST" id="formPenjualan">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="id_user" id="id_user" value="{{ Auth::user()->id }}" hidden>
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_pelanggan" class="form-control">
                                    ...
                                    <option value="{{ $pelanggan->id_pelanggan }}">{{ $pelanggan->namapelanggan }}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <table class="table" id="dataGrid">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="barang-row">
                                            ...
                                            <td>
                                                <input type="text" name="barang[{{ $barang->id_barang }}][hargajual]" value="{{ $barang->hargajual }}" class="form-control" readonly>
                                            </td>
                                            <td>
                                                <input type="number" name="barang[{{ $barang->id_barang }}][jumlah]" class="form-control jumlah-barang" min="0" value="0" data-harga="{{ $barang->hargajual }}" data-keuntungan="{{ $barang->keuntungan }}">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control total-harga" readonly value="{{ $barang->hargajual }}">
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                            ...
                            <div class="form-group row center">
                                ...
                                <div class="col-sm-3">
                                    <a href="{{ route('penjualan.index') }}" class="btn btn-primary px-3">
                                    ...
                                    fetch(form.action, {
                                        ...
                                        .then(data => {
                                            ...
                                            if (data.id_penjualan) {
                                                const urlDetailPenjualan = `{{ route('penjualan.detail', ':id_penjualan') }}`.replace(':id_penjualan', data.id_penjualan);
