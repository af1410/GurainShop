        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card" id="notaPembelian">
                    <div class="card-body">
                        ...
                        <div class="text-right">
                            <p><b>Total Bayar: </b>Rp {{ number_format($pembelian->total_bayar, 0, ',', '.') }}</p>
                            <p><b>Dibayar: </b>Rp {{ number_format($pembelian->dibayar, 0, ',', '.') }}</p>
                            <p><b>Kembali: </b>Rp {{ number_format($pembelian->kembali, 0, ',', '.') }}</p>
                        </div>
                ...
                <div class="text-center mt-3 pb-5">
                    <a href="{{ route('admin.pembelian.index') }}" class="btn btn-primary mr-3"> <i class="fa fa-arrow-left pr-1"></i>Kembali</a>
