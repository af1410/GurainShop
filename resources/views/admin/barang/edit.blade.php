                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.barang.update', $barang->id_barang) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="hargabarang" name="hargabarang" value="{{ $barang->hargabarang }}" required>
                            </div>

                            <div class="form-group">
                                <label for="hargajual">Harga Jual</label>
                                <input type="number" class="form-control" id="hargajual" name="hargajual" value="{{ $barang->hargajual }}" readonly>
                            </div>

                            <div class="form-group">
                                <label for="keuntungan">Keuntungan</label>
                                <input type="number" class="form-control" id="keuntungan" name="keuntungan" value="{{ $barang->keuntungan }}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="jumlahbarang">Jumlah Barang</label>
                                <input type="number" class="form-control" id="jumlahbarang" name="jumlahbarang" value="{{ $barang->jumlahbarang }}" required readonly>
                            </div>
                            <div class="mb-3">
                                ...
                                <select name="satuanbarang" class="form-control" id="satuanbarang" required>
                                    <option value="PCS" {{ old('satuanbarang') == 'PCS' ? 'selected' : '' }}>PCS</option>
                                    <option value="PACK" {{ old('satuanbarang') == 'PACK' ? 'selected' : '' }}>PACK</option>
                                    <option value="RIM" {{ old('satuanbarang') == 'RIM' ? 'selected' : '' }}>RIM</option>
                                    <option value="DUS" {{ old('satuanbarang') == 'DUS' ? 'selected' : '' }}>DUS</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group row center">
                                ...
                                <div class="col-sm-3">
                                    <a href="{{ route('admin.barang.index') }}" class="btn btn-primary px-3">
