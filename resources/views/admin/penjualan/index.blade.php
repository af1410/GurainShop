            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.penjualan.create') }}" class="btn btn-success mb-3"><i class="fas fa-plus"></i> Tambah Penjualan</a>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href=" {{ route('admin.penjualan.detail', $penjualan->id_penjualan) }} " class="btn btn-primary btn-sm"><i class="fas fa-info-circle pr-1"></i>Detail Penjualan</a></td>
                                    <!-- <ul>
