                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="border p-4 mb-4 rounded shadow-sm d-flex flex-column h-100">
                                    <form action="{{ route('admin.laporanbeli.harian') }}" method="POST" class="flex-grow-1 d-flex flex-column">
                                        @csrf
                            ...
                            <div class="col-md-4">
                                <div class="border p-4 mb-4 rounded shadow-sm d-flex flex-column h-100">
                                    <form action="{{ route('admin.laporanbeli.mingguan') }}" method="POST" class="flex-grow-1 d-flex flex-column">
                                        @csrf
                            ...
                            <div class="col-md-4">
                                <div class="border p-4 mb-4 rounded shadow-sm d-flex flex-column h-100">
                                    <form action="{{ route('admin.laporanbeli.bulanan') }}" method="POST" class="flex-grow-1 d-flex flex-column">
                                        @csrf
