...
class PenjualanController extends Controller
{
    ...
    public function create()
    {
        ...
        $barangs = Barang::all();
        $users = User::all();
        return view('admin.penjualan.create', compact('pelanggans', 'barangs', 'users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.penjualan.index')->with('success', 'Penjualan berhasil disimpan!');
    }
