...
class LaporanBeliController extends Controller
{
    ...
    {
        return view('admin.laporanbeli.index');
    }
    ...
    public function laporanHarian(Request $request)
    {
        ...
        return view('admin.laporanbeli.harian', compact('pembelianHarian', 'tanggal'));
    }
    ...
    public function laporanMingguan(Request $request)
    {
        ...
        return view('admin.laporanbeli.mingguan', compact('pembelians', 'tanggalAwal', 'tanggalAkhir'));
    }
    ...
    public function laporanBulanan(Request $request)
    {
        ...
        return view('admin.laporanbeli.bulanan', compact('pembelians', 'bulan', 'tahun'));
    }
}
