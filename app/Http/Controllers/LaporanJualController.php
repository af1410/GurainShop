...
class LaporanJualController extends Controller
{
    ...
    public function laporanHarian(Request $request)
    {
        ...
        return view('laporanjual.harian', compact('penjualanHarian', 'tanggal'));
    }
    ...
    public function laporanMingguan(Request $request)
    {
        ...
        return view('laporanjual.mingguan', compact('penjualans', 'tanggalAwal', 'tanggalAkhir'));
    }
    ...
    public function laporanBulanan(Request $request)
    {
        ...
        return view('laporanjual.bulanan', compact('penjualans', 'bulan', 'tahun'));
    }
}
