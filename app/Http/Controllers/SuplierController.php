...
class SuplierController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.suplier.index')->with('success', 'Suplier created successfully.');
    }
    ...
    public function update(Request $request, $id_suplier)
    {
        ...
        return redirect()->route('admin.suplier.index')->with('success', 'Suplier updated successfully.');
    }
    ...
    public function destroy($id_suplier)
    {
        ...
        if (!$suplier) {
            ...
            return redirect()->route('admin.suplier.index')->with('error', 'Suplier not found.');
        }
        $suplier->delete();
        return redirect()->route('admin.suplier.index')->with('success', 'Suplier deleted successfully.');
    }

    public function print()
    {
        $supliers = Suplier::all();
        return view('admin.suplier.print', compact('supliers'));
    }
}
