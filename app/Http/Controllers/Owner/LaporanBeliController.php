...
class LaporanBeliController extends Controller
{
    ...
    {
        return view('owner.laporanbeli.index');
    }
    ...
    public function laporanHarian(Request $request)
    {
        ...
        return view('owner.laporanbeli.harian', compact('pembelianHarian', 'tanggal'));
    }
    ...
    public function laporanMingguan(Request $request)
    {
        ...
        return view('owner.laporanbeli.mingguan', compact('pembelians', 'tanggalAwal', 'tanggalAkhir'));
    }
    ...
    public function laporanBulanan(Request $request)
    {
        ...
        return view('owner.laporanbeli.bulanan', compact('pembelians', 'bulan', 'tahun'));
    }
}
