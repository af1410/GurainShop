...
class LaporanJualController extends Controller
{
    ...
    {
        return view('owner.laporanjual.index');
    }
    ...
    public function laporanHarian(Request $request)
    {
        ...
        return view('owner.laporanjual.harian', compact('penjualanHarian', 'tanggal'));
    }
    ...
    public function laporanMingguan(Request $request)
    {
        ...
        return view('owner.laporanjual.mingguan', compact('penjualans', 'tanggalAwal', 'tanggalAkhir'));
    }
    ...
    public function laporanBulanan(Request $request)
    {
        ...
        return view('owner.laporanjual.bulanan', compact('penjualans', 'bulan', 'tahun'));
    }
}
