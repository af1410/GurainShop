...
<nav class="main-header navbar navbar-expand navbar-white navbar-dark bg-dark fixed-top">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block @if(request()->routeIs('owner.dashboard.*')) active @endif">
            <a href="{{ route('owner.dashboard') }}" class="nav-link ">Home</a>
        </li>
        ...
        <li class="nav-item d-none d-sm-inline-block @if(request()->routeIs('owner.owner.*')) active @endif">
            <a href="{{ route('owner.owner.index') }}" class="nav-link">User</a>
        </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <div class="dropdown-divider"></div>
                <a href="{{ route('logout') }}" class="dropdown-item" onclick="event.preventDefault(); if(confirm('Apakah Anda yakin ingin logout?')) { document.getElementById('logout-form').submit(); }">
